    ...
    <div class="col-span-3 lg:pr-24">
        @foreach ($posts as $post)
            <div class="w-full mb-24" data-aos="fade-up" data-aos-delay="100">
                ...
                <a class="font-bold text-xl uppercase border-b-2 border-black pb-1.5" href="{{ route('blog.show', $post->slug) }}">Leer Más</a>
            </div>
        @endforeach
        ...
        <div class="p-8 border border-gray-200 mb-8">
            ...
            <div class="my-5 space-y-5">
                @foreach ($recentPosts as $post)
                    <a class="block" href="{{ route('blog.show', $post->slug) }}">{{ $post->title }}</a>
                @endforeach
            </div>
        </div>
        <div class="p-8 border border-gray-200 mb-8">
