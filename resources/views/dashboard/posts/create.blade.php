            ...
            <div class="md:col-span-2">
                ...
                <div class="mb-3 bg-white py-5 px-4 rounded-md">
                    <div x-data="{photoName: null, photoPreview: null}">
                        ...
                        <div class="mt-2 w-full border border-gray-400 rounded-md border-dashed flex items-center text-center h-28 hover:border-blue-60 cursor-pointer" x-show="! photoPreview" x-on:click.prevent="$refs.photo.click()">
                        ...
                        <x-jet-secondary-button class="mt-2 text-sm" type="button" x-show="photoPreview" x-on:click.prevent="$refs.photo.click()">
