                ...
                <div class="mb-3 bg-white py-5 px-4 rounded-md">
                    <div x-data="{photoName: null, photoPreview: null}">
                        ...
                        <div class="mt-2" x-show="! photoPreview">
                            <img src="{{ Storage::url($post->image) }}" class="rounded h-28 w-full object-cover">
                        </div>
                        ...
                        <x-jet-secondary-button class="mt-2 text-sm" type="button" x-on:click.prevent="$refs.photo.click()">
