            ...
            <div class="md:grid md:grid-cols-8 md:gap-6">
                <div class="md:col-span-6 bg-white py-5 px-4 rounded-md">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-input" name="content" id="content">{{ $resource->content }}</textarea>
                ...
                <div class="md:col-span-2">
                    <div class="mb-3 bg-white py-5 px-4 rounded-md">
                        ...
                        <div class="mt-3">
                            {!! Form::submit(__('Actualizar Post'), ['class' => 'btn-primary w-full']) !!}
                        </div>
                    </div>
                    <div class="mb-3 bg-white py-5 px-4 rounded-md">
                    ...
                    <div class="mb-3 bg-white py-5 px-4 rounded-md">
                        <div>
                            ...
                            <div x-show="!path" class="mt-2">
                                <img class="w-full h-40 object-cover object-center rounded-md" src="{{ $resource->image }}">
                            </div>

                            <img x-show="path" class="w-full object-cover object-center rounded-md h-40 mt-2" x-bind:src="'{{ config('app.url') }}'+'/storage/'+path">

                            <x-jet-secondary-button class="mt-2 text-sm" type="button" @click="open = true">
                                {{ __('Selecionar Imagen') }}
                            </x-jet-secondary-button>

                            <input type="hidden" name="image" x-bind:value="path">
