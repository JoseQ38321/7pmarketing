<x-app-layout>
    <section class="md:max-w-3xl lg:max-w-7xl mx-auto mt-12 mb-24" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        ...
        <span class="block mt-2 mx-4 text-2xl">La mejor agencia de marketing digital</span>
    </section>
    <section data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        <video class="w-full object-cover h-650" autoplay muted playsinline loop
        src="{{ asset('assets/videos/about-us-banner.mp4') }}"></video>
    </section>
    <section class="md:max-w-3xl lg:max-w-7xl mx-auto mt-12 mb-24" :class="{ 'opacity-0' : services }">
    ...
    <section class="py-36 mx-auto max-w-7xl" id="services"
        @scroll.window="services = (window.pageYOffset >= (document.getElementById('services').offsetTop)-200 && window.pageYOffset <= (document.getElementById('services').offsetTop)+300) ? true : false ">
        ...
        <div :class="{ 'opacity-0' : !services }">
            <div class="mb-16 text-white space-y-2 w-3/5 mx-auto">
            ...
            <div class="grid grid-cols-4 gap-10 text-white">
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">01</span>
                    <h4 class="font-semibold text-xl -mt-8">Branding</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">02</span>
                    <h4 class="font-semibold text-xl -mt-8">Diseño Web</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">03</span>
                    <h4 class="font-semibold text-xl -mt-8">Diseño Gráfico</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">04</span>
                    <h4 class="font-semibold text-xl -mt-8">Copywriting</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">05</span>
                    <h4 class="font-semibold text-xl -mt-8">Multimedia</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">06</span>
                    <h4 class="font-semibold text-xl -mt-8">Marketing Digital</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">07</span>
                    <h4 class="font-semibold text-xl -mt-8">Even Management</h4>
                </div>
                <div class="flex items-center flex-col justify-center gap-2.5">
                    <img class="h-16 w-auto mx-auto" src="{{ asset('images/services/icon03.png') }}" alt="Branding">
                    <span class="font-bold text-gray-light text-4xl">08</span>
                    <h4 class="font-semibold text-xl -mt-8">Automatización</h4>
                </div>
            </div>
        </div>
    </section>
    <section class="py-10 max-w-7xl mx-auto" :class="{ 'opacity-0' : services || video }">
    ...
    <section class="py-36 mx-auto max-w-7xl" id="video"
        @scroll.window="video = (window.pageYOffset >= (document.getElementById('video').offsetTop)-250 && window.pageYOffset <= (document.getElementById('video').offsetTop)+500) ? true : false ">
